  ...
  return (
    <div className='h-[1085px] pb-[132px] flex flex-col justify-center items-center mx-auto overflow-hidden'>
      <Layout variant={
        ...
        <div className='w-[1320.167px] h-[522.078px] relative max-w-[1440px] md:mx-auto rounded-[60px]  mt-[37px]'>
      ...
      <Layout variant={
        ...
        <div 
          ...
          <div className='flex flex-col gap-[40px] items-center justify-center absolute top-[162px] left-1/2 transform -translate-x-1/2 '>
            <div className='flex flex-col gap-[16px] items-center justify-center'>
              <div className='rounded-full p-[1px] border-0' style={{
                ...
                <div className="rounded-full bg-black flex items-center justify-center w-fit px-4 py-3 space-x-2" style={{
                  background: "linear-gradient(162deg, #010214 14.93%, #16ff00 369.16%)"
                }}>
            ...
            <button className="bg-[#191919] rounded-full hover:shadow-none transition-all duration-500 ease-in-out py-3 px-4 text-white font-jetbrains flex items-center gap-x-2 shadow-[0px_2px_4px_0px_#16ff00_inset,0px_-4px_12px_0px_rgba(189,_255,_0,_0.50)]">
              <span>Discover</span>
